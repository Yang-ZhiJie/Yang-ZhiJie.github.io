<template>
  <div>
    ...
    <div class="steps-content" v-if="current==2">
      <a-form class="add-tag" :form="form3" @submit="handleSubmit">
        ...
        <!-- 上传图片 -->
        <a-form-item v-if="tagId==2" style="margin-left:550px;margin-top:40px;">
          <a-upload
        ...
        <a-form-item>
          <a-button class="add-product-button" @click="handleSubmit(2)" style="width:200px;">完成添加</a-button>
        </a-form-item>
      </a-form>
    </div>
    <div class="steps-action">
      ...
      <a-button
        ...
        @click="uploadpro"
      >点击完成</a-button>
      <a-button v-if="current>0" style="margin-left:10px" @click="prev">上一步</a-button>
    </div>
  </div>
</template>
<script>
